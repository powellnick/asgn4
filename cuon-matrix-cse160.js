...
class Vector3 {
    ...
    add(other) {
        ...
        var vector_1 = this.elements;
        var vector_2 = other.elements;
    ...
    div(scalar) {
        ...
        // This function should change this vector (this.elements) and not create a new vector.
        var vector_1 = this.elements;
        vector_1[0] = vector_1[0]/scalar;
        vector_1[1] = vector_1[1]/scalar;
        vector_1[2] = vector_1[2]/scalar;
        // Don't delete the return statement.
        return this;
    };
    ...
    static dot(other1, other2) {
        ...
        var vector_1 = other1.elements;
        var vector_2 = other2.elements;
        d += vector_1[0] * vector_2[0];
        d += vector_1[1] * vector_2[1];
        d += vector_1[2] * vector_2[2];
        // Don't delete the return statement.
        return d;
    }
    ...
    static cross(other1, other2) {
        ...
        var vector_1 = other1.elements;
        var vector_2 = other2.elements;
        v3.elements[0] = (vector_1[1]*vector_2[2]) - (vector_1[2]*vector_2[1]);
        v3.elements[1] = -((vector_1[0]*vector_2[2]) - (vector_1[2]*vector_2[0]));
        v3.elements[2] = (vector_1[0]*vector_2[1]) - (vector_1[1]*vector_2[0]);
        return v3;
    }
    ...
    magnitude() {
        ...
        var vector_1 = this.elements;
        m += (vector_1[0] * vector_1[0]);
        m += (vector_1[1] * vector_1[1]);
        m += (vector_1[2] * vector_1[2]);
        m = Math.sqrt(m);
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        ...
        var mag_vector = this.magnitude();
        v1[0] = v1[0]/mag_vector;
        v1[1] = v1[1]/mag_vector;
        v1[2] = v1[2]/mag_vector;
        // Don't delete the return statement.
        return this;
    };
}
